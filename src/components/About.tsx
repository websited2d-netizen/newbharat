      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Born from Passion</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Truly Inclusive</h3>
                  <p className="text-gray-600">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Beyond Just Money</h3>
                  <p className="text-gray-600">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-green-50 p-8 rounded-2xl">
            <h3 className="text-2xl font-bold text-gray-800 mb-6">Why PitchKaroIndia?</h3>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                <p className="text-gray-700">₹50+ Lakh total prize pool - India's most rewarding competition</p>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <p className="text-gray-700">Expert evaluation by IIT professors and industry veterans</p>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                <p className="text-gray-700">Direct access to 20+ active investors and VCs</p>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                <p className="text-gray-700">National platform with pan-India participation</p>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                <p className="text-gray-700">Comprehensive mentorship and networking opportunities</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Mission Statement */}
        <div className="text-center bg-gradient-to-r from-orange-500 to-green-600 text-white p-12 rounded-2xl">
          <Target className="h-12 w-12 mx-auto mb-6" />
          <div className="mb-6">
            <h3 className="text-4xl font-bold mb-2">₹50+ Lakh Prize Pool</h3>
            <p className="text-xl opacity-90">India's Most Rewarding Startup Competition</p>
          </div>
